...
const ServiceForm = () => {
  ...
  const fetchService = async () => {
    try {
      const response = await axios.get(`${API_CONFIG.API_BASE_URL}/services/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(`${API_CONFIG.API_BASE_URL}/services/${id}`, serviceData);
      } else {
        await axios.post(`${API_CONFIG.API_BASE_URL}/services`, serviceData);
      }
